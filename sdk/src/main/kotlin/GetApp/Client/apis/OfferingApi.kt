...
class OfferingApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun offeringControllerCheckHealth() : Unit {
        val localVarResponse = offeringControllerCheckHealthWithHttpInfo()
    ...
    fun offeringControllerCheckHealthWithHttpInfo() : ApiResponse<Unit?> {
        val localVariableConfig = offeringControllerCheckHealthRequestConfig()
    ...
    /**
     * To obtain the request config of the operation offeringControllerCheckHealth
     *
     * @return RequestConfig
     */
    fun offeringControllerCheckHealthRequestConfig() : RequestConfig<Unit> {
