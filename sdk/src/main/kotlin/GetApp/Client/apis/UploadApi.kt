...
class UploadApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun uploadControllerCheckHealth() : Unit {
        val localVarResponse = uploadControllerCheckHealthWithHttpInfo()
    ...
    fun uploadControllerCheckHealthWithHttpInfo() : ApiResponse<Unit?> {
        val localVariableConfig = uploadControllerCheckHealthRequestConfig()
    ...
    /**
     * To obtain the request config of the operation uploadControllerCheckHealth
     *
     * @return RequestConfig
     */
    fun uploadControllerCheckHealthRequestConfig() : RequestConfig<Unit> {
