...
class DeliveryApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun deliveryControllerCheckHealth() : Unit {
        val localVarResponse = deliveryControllerCheckHealthWithHttpInfo()
    ...
    fun deliveryControllerCheckHealthWithHttpInfo() : ApiResponse<Unit?> {
        val localVariableConfig = deliveryControllerCheckHealthRequestConfig()
    ...
    /**
     * To obtain the request config of the operation deliveryControllerCheckHealth
     *
     * @return RequestConfig
     */
    fun deliveryControllerCheckHealthRequestConfig() : RequestConfig<Unit> {
