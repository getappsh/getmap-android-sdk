...
class GetMapApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun getMapControllerCheckHealth() : Unit {
        val localVarResponse = getMapControllerCheckHealthWithHttpInfo()
    ...
    fun getMapControllerCheckHealthWithHttpInfo() : ApiResponse<Unit?> {
        val localVariableConfig = getMapControllerCheckHealthRequestConfig()
    ...
    /**
     * To obtain the request config of the operation getMapControllerCheckHealth
     *
     * @return RequestConfig
     */
    fun getMapControllerCheckHealthRequestConfig() : RequestConfig<Unit> {
