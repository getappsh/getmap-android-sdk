...
object HashUtils {
    ...
    fun getCheckSumFromFile(algorithm: String, filePath: String): String {
        val file = File(filePath)
        return getCheckSumFromFile(algorithm, file)
    }

    fun getCheckSumFromFile(algorithm: String, file: File): String {
