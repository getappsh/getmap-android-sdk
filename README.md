...
```
cd existing_repo
git remote add origin https://gitlab.com/ngsoft1/getapp-android-sdk.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ngsoft1/getapp-android-sdk/-/settings/integrations)
